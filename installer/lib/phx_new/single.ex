defmodule Phx.New.Single do
  ...
  template(:new, [
    ...
    {
      :eex,
      "phx_web/channels/user_socket.ex",
      :project,
      "lib/:lib_web_name/channels/user_socket.ex"
    },
    ...
    {
      :eex,
      "phx_test/views/error_view_test.exs",
      :project,
      "test/:lib_web_name/views/error_view_test.exs"
    }
  ])
  ...
  template(:gettext, [
    ...
    {
      :eex,
      "phx_gettext/en/LC_MESSAGES/errors.po",
      :project,
  ...
  template(:html, [
    {
      :eex,
      "phx_web/controllers/page_controller.ex",
      :project,
      "lib/:lib_web_name/controllers/page_controller.ex"
    },
    {
      :eex,
      "phx_web/templates/layout/app.html.eex",
      :project,
      "lib/:lib_web_name/templates/layout/app.html.eex"
    },
    {
      :eex,
      "phx_web/templates/page/index.html.eex",
      :project,
      "lib/:lib_web_name/templates/page/index.html.eex"
    },
    ...
    {
      :eex,
      "phx_test/views/layout_view_test.exs",
      :project,
      "test/:lib_web_name/views/layout_view_test.exs"
    },
    {
      :eex,
      "phx_test/views/page_view_test.exs",
      :project,
      "test/:lib_web_name/views/page_view_test.exs"
    }
  ])
