defmodule Phoenix.Controller.Pipeline do
  ...
  def __catch__(%Plug.Conn{}, :function_clause, controller, action,
    [{controller, action, [%Plug.Conn{} = conn | _] = action_args, _loc} | _] = stack) do
    args = [controller: controller, action: action, params: conn.params, arity: length(action_args), args: action_args]
