defmodule Phoenix.Router.Route do
  ...
  defstruct [:verb, :kind, :path, :host, :plug, :opts, :helper, :private, :pipe_through, :assigns]
  ...
  def forward(%Plug.Conn{path_info: path, script_name: script} = conn, fwd_segments, target, opts) do
    ...
    conn =
      %Plug.Conn{conn | path_info: new_path, script_name: script ++ base} |> target.call(opts)
